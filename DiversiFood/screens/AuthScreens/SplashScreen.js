  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.title}>Welcome to DiversiFood</Text>
        <Text style={styles.subtext}>Using ML To Add Nutrition and Diversification To Your Diet</Text>
      </View>
